...
public class javaFit
{
	...
	public static void main(String[] args)
	{
		...
		// NOTE: You do not need to handle cases where the user makes a typo. It is okay to error on that code, because
		// we will not, in the future, allow direct user input like this.
